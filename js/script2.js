...
navContador.className = 'navbar navbar-expand-lg navbar-light bg-light sticky container-fluid justify-content-center shadow-lg';
...
spanC.className = 'mr-2 font-weight-bold text-danger';
...
divHC.className = 'modal-header border-bottom border-danger';
...
divBC.className = 'modal-body border-bottom border-danger container';
...
btnEliminar.className = 'btn btn-dark col-4 ml-3';
btnEliminar.innerHTML = 'Vaciar carrito';
contTotal.appendChild(btnEliminar);
////
let totalPC = d.createElement('span');
totalPC.className = 'col-6 text-danger font-weight-bold border-top ml-5 pt-2';
...
btnComprarC.className = 'btn btn-success cerrar2 col ml-3 mr-2';
...
btnCerrarC.className = 'btn btn-danger col ml-2 mr-3';
...
imgM.className = 'card-img imagenM mx-auto row border-bottom border-danger';
